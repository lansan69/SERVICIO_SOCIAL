...
function renderConteoEstatus(conteoObject) {
    ...
    Object.values(conteoObject).forEach(status => {
        ...
        colorBox.style.borderRadius = "50%"; // Make it a circle
    ...
    hot = new Handsontable(container, {
        ...
        afterChange: function (changes, source) {
            ...
            changes.forEach(([row, prop, oldValue, newValue]) => {
                ...
                if (prop == "efe_cit"){
                    console.log("change on efe_cit", coloresFullMapEfec[hot.getDataAtCell(row, prop)]);
                    console.log("conteo efectividad: ", conteoEstadosEfec);
